...
#define cpu_map_h
  ...
  // Define step pulse bits in a parallel data byte
  #define X_STEP_BIT      0  // Uno Digital Pin 2
  #define Y_STEP_BIT      2  // Uno Digital Pin 3
  #define Z_STEP_BIT      4  // Uno Digital Pin 4
  #define STEP_MASK       ((1<<X_STEP_BIT)|(1<<Y_STEP_BIT)|(1<<Z_STEP_BIT)) // All step bits

  // Define step direction bits in a parallel data byte
  ...
  #define SPINDLE_PWM_MAX_VALUE     16 // Don't change. 328p fast PWM mode fixes top value as 255.
